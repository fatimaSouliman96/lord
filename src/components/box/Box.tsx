...
export default function Box() {
    return (
        <div className="w-full relative -z-2" >
            ...
            <button className="w-[226px] text-2xl border-0 py-1.5 px-4.5 font-semibold rounded-[10px] flex  items-center justify-center bg-[linear-gradient(180deg,#ffd15d_-23%,#ff9900_100%)] text-[#357faf]" >
                اشترك
            </button>
