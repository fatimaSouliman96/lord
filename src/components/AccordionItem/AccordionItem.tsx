    ...
    >
      <h2>
        <button
          ...
          className="w-full flex text-right justify-between items-center py-4 px-5  font-['Poppins'] text-[22px] font-normal leading-[1.3] text-[#5F6368] transition duration-300"
        >
          {title}
          <span
