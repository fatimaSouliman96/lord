  ...
  return (
    <footer dir="rtl" className="bg-[#eeeef5] text-[#595B62] font-medium ">
      ...
      <div className="pt-[80px] ">
        ...
        <div className="grid grid-cols-1 xl:px-40 lg:px-40 md:px-16 px-16 lg:grid-cols-4 md:grid-cols-2
        gap-8 lg:gap-0 xl:gap-0 md:gap-0 justify-center items-start pb-[45px]">
          ...
          >
            <div className='' >
              ...
              <p className="text-sm leading-relaxed">سرعة عالية<br />أسرع من الضوء</p>

              <ul className="mt-2 text-sm h-24">
                <li className="flex items-center gap-2 h-1/2">
                  ...
                  <a className="text-sm" href="http://wa.me/908508503131" target="_blank" rel="noreferrer">+90 850 850 31 31</a>
                </li>
                <li className="flex items-center gap-2 h-1/2 ">
                  <div className="w-8 icon  h-full">
                    <Lottie className='h-full' animationData={mail} loop={true} />
                  </div>
                  <a className="text-sm" href="mailto:destek@highspeed.com.tr">destek@highspeed.com.tr</a>
                </li>
              </ul>
            </div>
          </motion.div>
        ...
        <div className="border-t border-gray-200 bg-[#eeeef5]">
          <div className="container mx-auto px-4 pt-[25px] pb-[40px] text-center ">
            ...
            >    <p className="text-sm font-medium text-[#4188b5]">جميع الحقوق محفوظة ©2025 High Speed</p>
            </motion.div>
